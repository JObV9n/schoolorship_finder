...
export class UNScraper extends BaseStaticScraper {
  ...
  async scrape(): Promise<RawScholarship[]> {
    try {
      ...
      if (!scholarshipElements || scholarshipElements.length === 0) {
        ...
        $('h2, h3, h4').each((_: number, element: any) => {
          ...
          if (
            ...
            headingText.includes('opportunity')
          ) {
        ...
        $('a').each((_: number, element: any) => {
          ...
          if (
            ...
            scholarships.push({
              ...
              description: 'UN scholarship programme',
            });
          }
        });
      ...
      this.handleError(error as Error, 'scraping UN website');
      throw error;
    }
  }
