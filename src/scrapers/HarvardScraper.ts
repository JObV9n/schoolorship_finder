...
export class HarvardScraper extends BaseStaticScraper {
  ...
  async scrape(): Promise<RawScholarship[]> {
    try {
        ...
        $('a').each((_: number, element: any) => {
          ...
          if (
            ...
            scholarships.push({
              ...
              description: 'Harvard graduate funding opportunity',
            });
          }
        });
      ...
      this.handleError(error as Error, 'scraping Harvard website');
      throw error;
    }
  }
}